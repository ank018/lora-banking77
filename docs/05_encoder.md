...
At the full pool, three seeds, constrained: **0.23 pp**
(94.25 / 93.90 / 93.83). The encoder has only one regime — it emits a class
index, so `unparseable` cannot occur — but the figure is labelled anyway,
because the LoRA sd it is compared against differs by regime (0.26
constrained, 0.20 free-form).
